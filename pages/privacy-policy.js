...
export default function Privacy() {
	return (
		<div>
				...
				<meta property="og:url" content="https://www.texsasbd.com/privacy-policy" />
				<meta property="og:title" content="TEXSAS- Privacy Policy" />
    ...
    <Typography variant="h3" color="black.dark" className="padding100T">Privacy Policy			</Typography>
                        <br />
                        <Typography variant="h6" color="black.dark" className="padding100B">
							At texsasbd.com, accessible from <Link href='https://texsasbd.com/'>https://texsasbd.com/</Link> , one of our
							...
							and recorded by texsasbd.com and how we use it. 
                            <br />
                            If you have
							...
							collect in texsasbd.com. This policy is not applicable to any
                            ...
                            <br />
                             Log Files 
                             <br />
                             texsasbd.com follows a standard procedure
							...
							texsasbd.com uses cookies. These cookies are used to store
							...
							Policy for each of the advertising partners of texsasbd.com.
                            <br />
                            <br />
							Third-party ad servers or ad networks uses technologies like
							cookies, JavaScript, or Web Beacons that are used in their
							respective advertisements and links that appear on texsasbd.com,
                            ...
                            <br />
                            <br />
                            Note that texsasbd.com has no access to
                            ...
                            <br />
                            Under the CCPA, among other
							rights, California consumers have the right to:
                            <br />
                            <br />
                             Request that a
							business that collects a consumers personal data disclose the
                            ...
                            <br />The right to object to processing – You
							have the right to object to our processing of your personal data,
							under certain conditions.  <br />
                            <br />The right to data portability – You have
                            ...
                            <br />If you make a request, we have one month to
							respond to you. If you would like to exercise any of these rights,
							please contact us. <br />
                            <br /> Childrens Information 
                            <br /> Another part of our
                            ...
                            <br />
							texsasbd.com does not knowingly collect any Personal Identifiable
